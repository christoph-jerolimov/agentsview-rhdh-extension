module github.com/christoph-jerolimov/agentsview-rhdh-extension

go 1.26.3

tool go.kenn.io/agentsview/cmd/agentsview
...
require (
	...
	go.kenn.io/agentsview v0.39.0 // indirect
	go.kenn.io/kit v0.11.0 // indirect
